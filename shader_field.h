...
void Shader_field_SetAmbientColor(const DirectX :: XMFLOAT4& color);
void Shader_field_SetDirectionalLight(const DirectX::XMFLOAT4& vector, const DirectX::XMFLOAT4& color);
